...
void menu(string title, string opciones[], int inicio, int can){
    ...
    cout << (char)186; rlutil::setColor(rlutil::WHITE); centrar_texto(title, ' ', 41); rlutil::setColor(rlutil::GREEN); cout << (char)186;

    rlutil::locate(40, inicio+3);
    cout << (char)186; centrar_texto("", ' ', 41); cout << (char)186;

    rlutil::locate(40, inicio+4);
    cout << (char)204; centrar_texto("", (char)205, 41); cout << (char)185;
    ...
    for(int x = 0; x < can; x++){
        ...
        cout << (char)186; rlutil::setColor(rlutil::WHITE); centrar_texto(opciones[x], ' ', 41); rlutil::setColor(rlutil::GREEN); cout << (char)186;
    ...
    cout << (char)200; centrar_texto("", (char)205, 41); cout << (char)188;
}